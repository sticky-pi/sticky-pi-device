...
F 1 "Conn_02x10_Odd_Even" H 8550 3750 50  0000 C CNN
F 2 "Connector_PinSocket_2.54mm:PinSocket_2x10_P2.54mm_Vertical" H 8500 4450 50  0001 C CNN
...
F 1 "Si2319CDS" H 4205 4245 50  0000 L CNN
F 2 "Package_TO_SOT_SMD:SOT-23" H 4200 4125 50  0001 L CIN
F 3 "http://www.vishay.com/docs/66709/si2319cd.pdf" H 4000 4200 50  0001 L CNN
F 4 "Vishay Siliconix" H 4000 4200 50  0001 C CNN "Manufacturer"
F 5 "SI2319CDS-T1-GE3" H 4000 4200 50  0001 C CNN "part_number"
F 6 "" H 4000 4200 50  0001 C CNN "Vendor"
F 7 "SI2319CDS-T1-GE3" H 4000 4200 50  0001 C CNN "Part"
	1    4000 4200
	-1   0    0    1   
$EndComp
Wire Wire Line
